...
public class ScaleToFitScreen : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        float worldScreenHeight = GameObject.Find("UI Camera").GetComponent<Camera>().orthographicSize * 2;
        ...
        transform.localScale = new Vector3(
            ...
            worldScreenHeight / sr.sprite.bounds.size.y, sr.sprite.bounds.size.z);
    }
}
